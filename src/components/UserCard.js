...
const UserCard = ({first_name,last_name,id,date_of_birth,position,qualification,experience,del}) => {
    ...
    return (
            ...
            onPress={()=>navigation.dispatch(StackActions.push('View',{first_name,last_name,id,position,qualification,experience,date_of_birth,del}))}
            >
